...
|.5|Docs: doco generated , format not ugly  |[Docs](https://github.com/nehajaideep/WolfTrack2.0/tree/Group10StableBranch/docs/WolfTrackv2_Group10Docs)|.5|
...
|1|Docs: what: point descriptions of each class/function (in isolation)  |[Doc](https://github.com/nehajaideep/WolfTrack2.0/blob/Group10StableBranch/docs/WolfTrackv2_Group10Docs/WolfTrack%202%20_Class:Funtion_Documentation.pdf) |1|
...
|.5|issues are discussed before they are closed |[Issue discussed and closed](https://github.com/nehajaideep/WolfTrack2.0/issues/18)|.5|
...
|.5|test cases:.a large proportion of the issues related to handling failing cases. |[Failed Tests Resolution Milestone issues](https://github.com/nehajaideep/WolfTrack2.0/issues?q=is%3Aissue+is%3Aclosed+milestone%3A%22Failed+Test+Cases+Resolution%22)|.5|
|.5|test cases are routinely executed |[Github Action Flow](https://github.com/nehajaideep/WolfTrack2.0/runs/4112812732?check_suite_focus=true)|.5|
